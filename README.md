...
Административный интерфейс включает следующие функции (конкретные API-вызовы вам необходимо спроектировать самостоятельно):
 ...
 регистрация пользователя — с валидацией входных данных на соответствие требованиям, описанным выше; POST http://127.0.0.1:8000/api_admin/persons/
Content-Type: application/json

{
    "username": "OlgaSt", 
    "email":"olgast@gmail.com",
    "password":"123Qweasd@",
   
    "first_name":"OlgaStpeptsova"
    

    }

 получение списка пользователей; GET http://127.0.0.1:8000/api_admin/persons/
 удаление пользователя; DELETE http://127.0.0.1:8000/api_admin/persons/id/

 
 выход пользователя из системы — logout. POST http://127.0.0.1:8000/api_admin/logout/
